    ...
    */
    ...
    'connections' => [
        ...
        'mysql_cpm' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('CPM_DB_HOST', '127.0.0.1'),
            'port' => env('CPM_DB_PORT', '3306'),
            'database' => env('CPM_DB_DATABASE', 'forge'),
            'username' => env('CPM_DB_USERNAME', 'forge'),
            'password' => env('CPM_DB_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
